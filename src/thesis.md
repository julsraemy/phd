...
This section establishes the epistemological foundations, presenting {{ "ANT" | abbr | safe }}, {{ "BO" | abbr | safe }}, and {{ "PI" | abbr | safe }}, alongside Donna Haraway's {{ "SK" | abbr | safe }}. Rather than synthesising these theories, this chapter places an emphasis on situating {{ "LOUD" | abbr | safe }} within a feminist perspective to construct a new materialistic foundation reminiscent of Haraway's [@haraway_staying_2016 p. 42]. This assemblage seeks to navigate the controversies and mappings within {{ "LOUD" | abbr | safe }}-like communities, applying a Tardian approach to trace the spreadability of ideas @latour_whole_2012.
